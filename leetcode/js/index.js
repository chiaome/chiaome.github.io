Highcharts.chart('container', {
    ...
    series: [{
        name: 'First Round',
        data: [2, 5, 3, 5, 6, 5, 4, 5, 6, 5, 6, 5, 0, 2, 7, 5, 10, 0, 0, 2, 1, 0, 0, 5, 6, 5, 1]
    }]
});
...
Highcharts.chart('container2', {
    ...
    series: [{
        name: 'Done',
        data: [290, 292, 297, 300, 305, 309, 314, 320, 326, 331, 337, 342, 342, 344, 354, 359, 369, 369, 369, 371, 372, 372, 372, 377, 383, 388, 389]
    },{
        name: 'Expected',
